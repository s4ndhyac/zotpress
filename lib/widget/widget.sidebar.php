				...
				<div id="zp-Sidebar-Widget-Container">
					...
					<p>
						...
						<select id="<?php echo $this->get_field_id( 'data_type' ); ?>" name="<?php echo $this->get_field_name( 'data_type' ); ?>" class="widefat">
							<option value="items" <?php if ( 'items' == $instance['data_type'] ) echo 'selected="selected"'; ?>><?php _e('Items','zotpress'); ?></option>
							<option value="tags" <?php if ( 'tags' == $instance['data_type'] ) echo 'selected="selected"'; ?>><?php _e('Tags','zotpress'); ?></option>
							<option value="collections" <?php if ( 'collections' == $instance['data_type'] ) echo 'selected="selected"'; ?>><?php _e('Collections','zotpress'); ?></option>
						</select>
					</p>
					...
					<p>
						...
						<select id="<?php echo $this->get_field_id( 'sortby' ); ?>" name="<?php echo $this->get_field_name( 'sortby' ); ?>" class="widefat">
							...
							<option value="author" <?php if ( 'author' == $instance['sortby'] ) echo 'selected="selected"'; ?>><?php _e('Author','zotpress'); ?></option>
							<option value="date" <?php if ( 'date' == $instance['sortby'] ) echo 'selected="selected"'; ?>><?php _e('Date','zotpress'); ?></option>
							<option value="title" <?php if ( 'title' == $instance['sortby'] ) echo 'selected="selected"'; ?>><?php _e('Title','zotpress'); ?></option>
						</select>
					</p>
					...
					<p>
						...
						<select id="<?php echo $this->get_field_id( 'sort' ); ?>" name="<?php echo $this->get_field_name( 'sort' ); ?>" class="widefat">
							<option value="desc" <?php if ( 'desc' == $instance['sort'] ) echo 'selected="selected"'; ?>><?php _e('Desc','zotpress'); ?></option>
							<option value="asc" <?php if ( 'asc' == $instance['sort'] ) echo 'selected="selected"'; ?>><?php _e('Asc','zotpress'); ?></option>
						</select>
					</p>
					...
					<p>
						...
						<select id="<?php echo $this->get_field_id( 'inclusive' ); ?>" name="<?php echo $this->get_field_name( 'inclusive' ); ?>" class="widefat">
							<option value="yes" <?php if ( 'yes' == $instance['inclusive'] ) echo 'selected="selected"'; ?>><?php _e('Yes','zotpress'); ?></option>
							<option value="no" <?php if ( 'no' == $instance['inclusive'] ) echo 'selected="selected"'; ?>><?php _e('No','zotpress'); ?></option>
						</select>
					</p>
					...
					<p>
						...
						<select id="<?php echo $this->get_field_id( 'image' ); ?>" name="<?php echo $this->get_field_name( 'image' ); ?>" class="widefat">
							<option value="no" <?php if ( 'no' == $instance['image'] ) echo 'selected="selected"'; ?>><?php _e('No','zotpress'); ?></option>
							<option value="yes" <?php if ( 'yes' == $instance['image'] ) echo 'selected="selected"'; ?>><?php _e('Yes','zotpress'); ?></option>
						</select>
					</p>
					...
					<p>
						...
						<select id="<?php echo $this->get_field_id( 'download' ); ?>" name="<?php echo $this->get_field_name( 'download' ); ?>" class="widefat">
							<option value="no" <?php if ( 'no' == $instance['download'] ) echo 'selected="selected"'; ?>><?php _e('No','zotpress'); ?></option>
							<option value="yes" <?php if ( 'yes' == $instance['download'] ) echo 'selected="selected"'; ?>><?php _e('Yes','zotpress'); ?></option>
						</select>
					</p>
					...
					<p>
						...
						<select id="<?php echo $this->get_field_id( 'zptitle' ); ?>" name="<?php echo $this->get_field_name( 'zptitle' ); ?>" class="widefat">
							<option value="no" <?php if ( 'no' == $instance['zptitle'] ) echo 'selected="selected"'; ?>><?php _e('No','zotpress'); ?></option>
							<option value="yes" <?php if ( 'yes' == $instance['zptitle'] ) echo 'selected="selected"'; ?>><?php _e('Yes','zotpress'); ?></option>
						</select>
					</p>
					...
					<p>
						...
						<select id="<?php echo $this->get_field_id( 'zpnotes' ); ?>" name="<?php echo $this->get_field_name( 'zpnotes' ); ?>" class="widefat">
							<option value="no" <?php if ( 'no' == $instance['zpnotes'] ) echo 'selected="selected"'; ?>><?php _e('No','zotpress'); ?></option>
							<option value="yes" <?php if ( 'yes' == $instance['zpnotes'] ) echo 'selected="selected"'; ?>><?php _e('Yes','zotpress'); ?></option>
						</select>
					</p>
					...
					<p>
						...
						<select id="<?php echo $this->get_field_id( 'zpcite' ); ?>" name="<?php echo $this->get_field_name( 'zpcite' ); ?>" class="widefat">
							<option value="no" <?php if ( 'no' == $instance['zpcite'] ) echo 'selected="selected"'; ?>><?php _e('No','zotpress'); ?></option>
							<option value="yes" <?php if ( 'yes' == $instance['zpcite'] ) echo 'selected="selected"'; ?>><?php _e('Yes','zotpress'); ?></option>
						</select>
					</p>
