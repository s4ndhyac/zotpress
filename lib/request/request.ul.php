    ...
    if($createAttachmentResponse->isError()){
      ...
      if(!isset($uploadheaders['Zotero-API-Key'])){
        ...
        if(TRUE){
            ...
            $upzresponse = HttpResponse::fromString($upresponseBody);
            ...
            if(!empty($resObject['exists'])){
              ...
              if(!isset($uploadHeaders['Zotero-API-Key'])){
                ...
                if(TRUE){
                    ...
                    $upFilezresponse = HttpResponse::fromString($upFileresponseBody);
                ...
                if($upFilezresponse->getStatus() == 201){
                  ...
                  if(!isset($regHeaders['Zotero-API-Key'])){
                    ...
                    if(TRUE){
                        ...
                        $regFilezresponse = HttpResponse::fromString($regFileresponseBody);
                    ...
                    if($regFilezresponse->getStatus() == 204){
                      ...
                      libZoteroDebug("error in registering upload ");
                        return false;
                    }
                }
                else{
                  libZoteroDebug("error in  uploading file ");
                    return false;
                }
            }
        }
